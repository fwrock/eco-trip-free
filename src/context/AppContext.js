...
export const AppContextProvider = (props) => {
    ...
    const [searchOriginCtx, setSearchOriginCtx] = useState({});
    const [searchDestinationCtx, setSearchDestinationCtx] = useState({});
    ...
    return (
        <AppContext.Provider
            value={{
                ...
                searchOriginCtx,
                setSearchOriginCtx,
                searchDestinationCtx,
                setSearchDestinationCtx,
                favorites,
                setFavorites,
                addFavorite,
                setAddFavorite,
